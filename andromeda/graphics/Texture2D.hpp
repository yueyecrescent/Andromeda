...
namespace andromeda {
	namespace graphics {
		...
		{
			NONE=0,//无贴图
			COLOR_MAP=1,SPECULAR_MAP,AMBIENT_MAP,EMISSIVE_MAP,HEIGHT_MAP,NORMAL_MAP,SHININESS_MAP,OPACITY_MAP,DISPLACEMENT_MAP,LIGHT_MAP,REFLECTION,//通用贴图
		...
		public:
			...
			Texture2D(andromeda::image::RasterImage img,TextureType type=TextureType::UNKNOWN) :
